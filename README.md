...
| `skills/github-provision` | Detection-first GitHub connector: account, gh auth (`repo`+`workflow`), git identity from the profile, verified email |
| `skills/vercel-provision` | Detection-first Vercel connector: Hobby account via Continue-with-GitHub, CLI device-flow login, GitHub app connected — deploy-ready |
